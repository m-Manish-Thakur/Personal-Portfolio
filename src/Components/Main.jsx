      ...
      <div id='Main'>
        ...
        <div className='child_main'>
                <div className="main_content" data-aos="fade-right" data-aos-offset="300">
                    ...
                    <h2>Hello, I'm </h2>
                    <h1>Manish Thakur <span>👋</span></h1>
                    <div id='role'><div style={{height:'1px', width:'80px', background:'#282856', marginRight:'10px'}}></div>
                    <TypeAnimation
                      sequence={[
                    ...
                    <div className="button_group">
                      <Link to='/contact'><button className='btn1'> Say Hello <i class="fa-regular fa-paper-plane"></i></button></Link>
                      <Link to='/portfolio'><button className='btn2'>My Works <i class="fa-solid fa-arrow-up-long"></i></button></Link>
                    </div>
