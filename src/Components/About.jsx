            ...
            <div id="about">
                    <div className='my_info' data-aos="fade-right" data-aos-offset="300">
                            <div className='item'>
                                    ...
                                    <Link to='/portfolio'><button style={{cursor:'pointer'}} className='btn3'>Got a project?</button></Link>
                            </div>
                            <div className='info_text'>
                                    ...
                                    <br /><br />
                                        Innovative  MERN Stack Developer with a passion for creating dynamic and responsive web applications.
                                        Adept in both frontend and backend development, with hands-on experience in HTML5, CSS3, JavaScript, React.js, Node.js, and MongoDB, Rest API.
                                        Skilled in building and optimizing web applications, and continuously seeking to expand knowledge in emerging web technologies.
                                    </p>
                            </div>
                    </div>
                    ...
                    <div id="skills">
                        ...
                        <div className="skill_con">
                                ...
                                <div className='item' >
                                    <img src="https://cdn.worldvectorlogo.com/logos/postman.svg" alt="" />
                                    <div style={{marginLeft:'25px'}}>
                                        <h2>Postman</h2>
                                        <p>API Platform</p>
                                    </div>
